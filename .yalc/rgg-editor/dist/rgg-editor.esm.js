import React, { useState, useEffect, useMemo, useCallback, useRef, useContext, createContext, useLayoutEffect } from 'react';
import { createStyled } from '@stitches/react';
import { FaFolderOpen, FaFolder, FaCube, FaCaretUp, FaCaretDown, FaPlus, FaTimes, FaMousePointer, FaUndo, FaRedo } from 'react-icons/fa';
import Tree, { mutateTree, moveItemOnTree } from '@atlaskit/tree';
import create from 'zustand';
import { persist } from 'zustand/middleware';
import { useProxy, proxy, ref } from 'valtio';
import { sortBy } from 'lodash-es';
import hotkeys from 'hotkeys-js';
import { BodyStatus } from '@dimforge/rapier3d-compat';
import { Euler, Quaternion, Object3D, Raycaster, Vector3, MeshBasicMaterial, DoubleSide, LineBasicMaterial, CylinderGeometry, BoxGeometry, BufferGeometry, Float32BufferAttribute, Mesh, Line, OctahedronGeometry, PlaneGeometry, TorusGeometry, SphereGeometry, Matrix4, Color, BoxHelper, Box3 } from 'three';
import { useRapier3DBody, useBodyApi } from 'rgg-engine';
import { Sphere, Box, useHelper, PerspectiveCamera, OrbitControls, Plane } from '@react-three/drei';
...
var _createStyled = /*#__PURE__*/createStyled({
  tokens: {
    colors: {
      $darkGrey: '#0c0c0c',
...
var TextInput = function TextInput(_ref) {
  ...
  return React.createElement(StyledContainer, null, React.createElement(StyledInput, {
    id: inputId,
    type: "text",
    value: inputValue,
    onChange: onChange
...
var NumberInput = function NumberInput(_ref) {
  ...
  var _useState = useState(value != null ? value : 0),
      inputValue = _useState[0],
      setInputValue = _useState[1];
  ...
  return React.createElement(StyledContainer$1, null, React.createElement(StyledInput, {
    id: inputId,
    type: "number",
    value: inputValue,
    onChange: onChange
...
var UnknownInput = function UnknownInput(props) {
  ...
  return React.createElement(InputComponent, Object.assign({}, props));
};
...
var MultiNumberInput = function MultiNumberInput(_ref) {
  var inputId = _ref.inputId,
      value = _ref.value,
      passedOnChange = _ref.onChange;
  return React.createElement(StyledContainer$2, null, Object.entries(value).map(function (_ref2, index) {
    ...
    return React.createElement(StyledItem, {
      ...
      htmlFor: id
    }, entryKey), React.createElement(UnknownInput, {
      inputId: id,
      value: entryValue,
...
var useMainStateStore = /*#__PURE__*/create( /*#__PURE__*/persist(function () {
...
var editorStateProxy = /*#__PURE__*/proxy({
  editMode: false,
...
var clipboardProxy = /*#__PURE__*/proxy({
  pendingPaste: null
});
...
var useHistoryStore = /*#__PURE__*/create( /*#__PURE__*/persist(function () {
  return {
    pastSnapshots: [],
    futureSnapshots: []
  };
...
var RigidBody3DModuleVisualizer = function RigidBody3DModuleVisualizer(_ref4) {
  ...
  return React.createElement("group", {
    ...
    return React.createElement(ColliderVisualiser, {
      collider: collider,
      key: collider.key
    });
  }));
...
var RigidBody3DModuleWrapper = function RigidBody3DModuleWrapper(_ref5) {
  ...
  return React.createElement(React.Fragment, null, !isEditMode && React.createElement(RigidBody3DModule, {
    meshRef: meshRef,
    value: value
  }), React.createElement(RigidBody3DModuleVisualizer, {
    value: value,
    visible: isEditMode
  }));
};
...
var EditableModules = function EditableModules(_ref6) {
  ...
  return React.createElement(React.Fragment, null, children, rigidBody3d && React.createElement(RigidBody3DModuleWrapper, {
    value: rigidBody3d
  }));
};
...
TransformControls.prototype = /*#__PURE__*/Object.assign( /*#__PURE__*/Object.create(Object3D.prototype), {
...
TransformControlsGizmo.prototype = /*#__PURE__*/Object.assign( /*#__PURE__*/Object.create(Object3D.prototype), {
...
var TransformControlsPlane = function TransformControlsPlane() {
  ...
  Mesh.call(this, new PlaneGeometry(100000, 100000, 2, 2), new MeshBasicMaterial({
    visible: false,
    wireframe: true,
    side: DoubleSide,
    transparent: true,
...
TransformControlsPlane.prototype = /*#__PURE__*/Object.assign( /*#__PURE__*/Object.create(Mesh.prototype), {
...
var useCallbackRef = function useCallbackRef(cb, dependencies) {
  var callback = useCallback(cb, dependencies);
...
var useDraggableMesh = function useDraggableMesh(id, isSelected, options) {
  ...
  var orbitRef = useProxy(editorStateProxy).orbitRef;
  ...
  var _useState2 = useState(isShiftPressed()),
  ...
  var startPositionRef = useRef(new Vector3());
  useEffect(function () {
  ...
  var onMouseUpRef = useRef(onMouseUp);
  useEffect(function () {
...
var useMeshHelper = function useMeshHelper(ref, active) {
  var helperToUse = useMemo(function () {
    if (active) {
      return BoxHelper;
    }
  ...
  var helperRef = useHelper(ref, helperToUse);
  useEffect(function () {
...
var InteractiveMesh = function InteractiveMesh(_ref) {
  ...
  var content = React.createElement("group", {
    ref: groupRef,
...
var Editable = function Editable(_ref2) {
  ...
  var isSoleSelected = useMemo(function () {
  ...
  var updatedParentPath = useMemo(function () {
  ...
  var setSharedProp = useCallback(function (key, value) {
  ...
  }, React.createElement(InteractiveMesh, null, React.createElement(EditableModules, null, children)));
};
...
var UnsavedComponent = function UnsavedComponent(_ref) {
  ...
  return React.createElement(Editable, Object.assign({
    id: component.uid,
    _config: {
      name: component.name,
  ...
  }, props), Component && React.createElement(Component, null));
};
...
var TemporaryComponent = function TemporaryComponent(_ref2) {
  ...
  return React.createElement(UnsavedComponent, {
    component: component
  });
};
...
var TemporaryComponentsList = function TemporaryComponentsList(_ref3) {
  var ids = _ref3.ids;
  return React.createElement(React.Fragment, null, ids.map(function (id) {
    return React.createElement(TemporaryComponent, {
      id: id,
      key: id
    });
  }));
...
var TemporaryComponents = function TemporaryComponents() {
  ...
  return React.createElement(React.Fragment, null, Object.entries(unsavedComponents).map(function (_ref4) {
    var key = _ref4[0],
        component = _ref4[1];
...
var EditableChildren = function EditableChildren(_ref) {
  ...
  return React.createElement(React.Fragment, null, children, storedChildren && React.createElement(TemporaryComponentsList, {
    ids: storedChildren
  }));
};

var EmptyObject = function EmptyObject() {
  return React.createElement(EditableChildren, null);
};
...
var useIsComponentHovered = function useIsComponentHovered(id) {
  ...
  var hoveredComponents = useProxy(uiProxy).hoveredComponents;
...
var shortcutsManager = /*#__PURE__*/new Shortcuts();
...
var generateTree = function generateTree(components, groups, groupedComponents, showActive) {
  ...
  Object.values(items).forEach(function (item) {
    if (componentsTree[item.id]) {
      ...
      var sortedChildren = sortBy(item.children, function (child) {
...
var ItemIcon = function ItemIcon(_ref4) {
  ...
  if (iconType === SceneItemIcon.group) {
    return React.createElement(FaFolderOpen, {
      size: 11
    });
  } else if (iconType === SceneItemIcon.groupClosed) {
    return React.createElement(FaFolder, {
      size: 11
    });
  }

  return React.createElement(FaCube, {
    size: 11
  });
};
var sidePadding = 12;
...
var SceneChild = function SceneChild(_ref5) {
  ...
  if (!data) return null;
  return React.createElement(SceneItem, {
    id: id,
...
var SceneChildren = function SceneChildren(_ref6) {
  ...
  return React.createElement(StyledChildrenContainer, null, children.map(function (childId) {
    return React.createElement(SceneChild, {
      id: childId,
      key: childId
    });
  }));
...
var selectRange = function selectRange(id) {
  ...
  if (!lastSelectedItem) {
    ...
    var sorted = sortBy(_selectedComponents, function (child) {
...
var SceneItem = function SceneItem(_ref8) {
  ...
  var updateName = useCallback(function (updatedName) {
  ...
  return React.createElement(React.Fragment, null, focused && React.createElement(SelectedComponentListeners, null), React.createElement(StyledDraggableContainer, null, React.createElement(StyledWrapper, null, React.createElement(StyledClickable, {
    ref: buttonRef,
    onClick: onClick,
    onFocus: onFocus,
    onBlur: onBlur,
  ...
  }, React.createElement(StyledIcon, Object.assign({}, iconProps, {
    style: draggable ? 'interactive' : ''
  }), icon), React.createElement("div", null, React.createElement("span", {
    onClick: onNameClicked
  }, name), isGroup && React.createElement(StyledToggleIcon, {
    onClick: function onClick(event) {
      event.preventDefault();
      event.stopPropagation();
      passedOnClick();
    }
  }, isExpanded ? React.createElement(FaCaretUp, {
    size: 11
  }) : React.createElement(FaCaretDown, {
    size: 11
  }))), React.createElement(StyledOptions, null, canHaveChildren && React.createElement(StyledTrash, {
    style: "interactive",
    onClick: onAddChild
  }, React.createElement(FaPlus, {
    size: 10
  })))), editingName && React.createElement(EditName, {
    name: name,
    onChange: updateName
  }))), !isGroup && React.createElement(SceneChildren, {
    id: id
  }));
};
...
var Draggable = function Draggable(_ref9) {
  ...
  }, provided.draggableProps), React.createElement(SceneItem, {
    id: item.id,
...
var SceneList = function SceneList(_ref11) {
  ...
  var _useMemo2 = useMemo(function () {
    return {
      onExpand: function onExpand(itemId) {
        setState(mutateTree(tree, itemId, {
          isExpanded: true
        }));
      ...
      onDragEnd: function onDragEnd(source, destination) {
        ...
        var updatedTree = moveItemOnTree(tree, source, destination);
  ...
  return React.createElement(StyledContainer$3, null, React.createElement(Tree, {
    tree: tree,
...
var ManagerSidebar = function ManagerSidebar() {
  var _useState = useState(VIEWS.active),
      selectedView = _useState[0],
      setSelectedView = _useState[1];

  return React.createElement(StyledContainer$4, null, React.createElement(StyledHeader, {
    visual: "top"
  }, React.createElement(StyledHeading, null, "Scene"), React.createElement("div", null, React.createElement("select", {
    value: selectedView,
    onChange: function onChange(event) {
  ...
  }, "Deactivated")))), React.createElement(StyledBox, {
    ...
    view: selectedView
  })), React.createElement(StyledPaddedBox, {
    visual: "bottom"
  }, React.createElement(StyledPlainButton, {
    shape: "full",
    onClick: function onClick() {
...
var PropInputOptions = function PropInputOptions(_ref) {
  ...
  var applyValue = useCallback(function () {
  ...
  return React.createElement(StyledHeaderOptions, null, (propType === PropOrigin.modified || propType === PropOrigin.initial) && React.createElement(React.Fragment, null, React.createElement(StyledTextButton, {
    onClick: onReset
  }, "reset"), !!componentTypeId && React.createElement(StyledTextButton, {
    onClick: applyValue
  }, "apply")));
};
...
var Module = function Module(_ref) {
  ...
  var propConfig = useMemo(function () {
  ...
  }, React.createElement("div", null, InputComponent && React.createElement(InputComponent, {
    inputId: inputId,
...
var ComponentModules = function ComponentModules(_ref2) {
  var componentId = _ref2.componentId,
      ...
      props = _ref2.props;
  return React.createElement("div", null, Object.entries(props).map(function (_ref3) {
    var propKey = _ref3[0],
        prop = _ref3[1];
...
var RigidBody3DColliderInput = function RigidBody3DColliderInput(_ref) {
  ...
  return React.createElement(StyledColliderContainer, null, React.createElement(StyledInputWrapper$1, {
    css: {
      gridTemplateColumns: 'auto 1fr auto',
      marginTop: '0'
    }
    ...
    htmlFor: key + "-shape"
  }, "Shape"), React.createElement("div", null, React.createElement(SelectInput, {
    inputId: key + "-shape",
    value: colliderType,
    onChange: function onChange(newValue) {
      updateValue({
    ...
    size: 11
  })))), colliderType === RigidBodyColliderShape.BALL && React.createElement(React.Fragment, null, React.createElement(StyledInputWrapper$1, null, React.createElement(StyledInputLabel, {
    htmlFor: key + "-radius"
  }, "Radius"), React.createElement(NumberInput, {
    inputId: key + "-radius",
    value: radius,
    onChange: function onChange(newValue) {
      updateValue({
  ...
  }))), colliderType === RigidBodyColliderShape.CUBIOD && React.createElement(React.Fragment, null, React.createElement(StyledInputWrapper$1, null, React.createElement(StyledInputLabel, {
    htmlFor: key + "-hx"
  }, "hx"), React.createElement(NumberInput, {
    inputId: key + "-hx",
    value: hx,
    onChange: function onChange(newValue) {
      updateValue({
  ...
  })), React.createElement(StyledInputWrapper$1, null, React.createElement(StyledInputLabel, {
    htmlFor: key + "-hy"
  }, "hy"), React.createElement(NumberInput, {
    inputId: key + "-hy",
    value: hy,
    onChange: function onChange(newValue) {
      updateValue({
    ...
    htmlFor: key + "-hz"
  }, "hz"), React.createElement(NumberInput, {
    inputId: key + "-hz",
    value: hz,
    onChange: function onChange(newValue) {
      updateValue({
...
var RigidBody3DInput = function RigidBody3DInput(_ref2) {
  ...
  return React.createElement(StyledContainer$5, null, React.createElement(StyledHeader$1, null, React.createElement("div", null, React.createElement("input", {
    id: inputId,
    type: "checkbox",
    checked: enabled,
    onChange: function onChange(event) {
  ...
  })), React.createElement(StyledBox$1, {
    css: {
      display: 'grid',
      alignItems: 'center',
      gridTemplateColumns: 'auto 1fr',
    ...
    htmlFor: inputId
  }, "RigidBody 3D"), React.createElement(PropInputOptions, {
    propKey: propKey,
    propType: propType,
    componentId: componentId,
    componentTypeId: componentTypeId,
  ...
  }, isExpanded ? React.createElement(FaCaretUp, null) : React.createElement(FaCaretDown, null)))), isExpanded && React.createElement(StyledBody, null, React.createElement(StyledInputWrapper$1, null, React.createElement(StyledInputLabel, {
    htmlFor: "rigidBody3d-type"
  }, "Type"), React.createElement("div", null, React.createElement(SelectInput, {
    ...
    options: options
  }))), bodyType === RigidBodyType.DYNAMIC && React.createElement(StyledInputWrapper$1, null, React.createElement(StyledInputLabel, {
    htmlFor: "rigidBody3d-mass"
  }, "Mass"), React.createElement("div", null, React.createElement(NumberInput, {
  ...
  }))), React.createElement(StyledCollidersContainer, null, React.createElement(StyledCollidersHeader, null, React.createElement("div", null, React.createElement(StyledInputLabel, null, "Colliders")), React.createElement(StyledPlainButton, {
    shape: "thinnerWide",
    onClick: addCollider
  }, "Add Collider")), colliders.length > 0 && React.createElement("div", null, colliders.map(function (collider, index) {
    return React.createElement("div", {
      key: collider.key
    }, React.createElement(RigidBody3DColliderInput, {
      collider: collider,
      onChange: function onChange(newValue) {
...
var PropInput = function PropInput(_ref) {
  ...
  return React.createElement(StyledProp, null, React.createElement(StyledHeader$2, null, React.createElement(StyledHeaderLabel, {
    htmlFor: inputId
  }, label || propKey), React.createElement(PropInputOptions, {
    propKey: propKey,
    propType: propType,
    componentId: componentId,
    componentTypeId: componentTypeId,
    inputValue: inputValue
  })), React.createElement(StyledInputContainer, null, React.createElement(Module, {
    propType: propType,
    componentId: componentId,
    componentTypeId: componentTypeId,
    value: value,
...
var CustomProps = function CustomProps(_ref4) {
  var componentId = _ref4.componentId,
      ...
      props = _ref4.props;
  return React.createElement("div", null, Object.entries(props).sort(sortProps).map(function (_ref5) {
    var key = _ref5[0],
        prop = _ref5[1];
    return React.createElement(PropInput, {
      componentId: componentId,
      componentTypeId: componentTypeId,
      key: key,
      propKey: key,
...
var ComponentState = function ComponentState(_ref6) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(StyledContainer$6, null, React.createElement(CustomProps, {
    componentId: id,
    componentTypeId: componentTypeId,
    props: customProps
  }), modules && React.createElement(ComponentModules, {
    componentId: id,
    componentTypeId: componentTypeId,
    props: bottomProps
  })), modules && React.createElement(StyledPaddedBox, {
    visual: "bottom"
  }, React.createElement(StyledPlainButton, {
    shape: "full",
    onClick: addModule
...
var SidebarHeader = function SidebarHeader(_ref) {
  ...
  return React.createElement(StyledPaddedBox, {
    visual: "top"
  }, React.createElement(StyledHeading, null, name));
};
...
var StateSidebar = function StateSidebar() {
  ...
  }, React.createElement(StyledContainer$7, null, React.createElement(SidebarHeader, {
    id: selectedComponent
  }), React.createElement(ComponentState, {
    id: selectedComponent,
...
var AddableComponent = function AddableComponent(_ref) {
  ...
  return React.createElement(StyledAddableComponent, {
    onClick: function onClick() {
      addComponent$1(addableId, uiProxy.displayAddingComponentParent);
      closeAddingComponent();
    }
  }, React.createElement(StyledIcon, null, React.createElement(ItemIcon, {
    iconType: SceneItemIcon.component
  })), React.createElement("div", null, label), React.createElement(StyledIcon, {
  ...
  }, React.createElement(StyledIconWrapper, null, React.createElement(FaMousePointer, {
    size: 10
  }))));
};

var AddingComponentMenu = function AddingComponentMenu() {
  var isAddingComponent = useProxy(uiProxy).displayAddingComponent;
  ...
  }, React.createElement(StyledContainer$8, null, Object.entries(addables).map(function (_ref2) {
    var key = _ref2[0],
        addable = _ref2[1];
    return React.createElement(AddableComponent, {
...
var ComponentsMenu = function ComponentsMenu(_ref) {
  ...
  var options = useMemo(function () {
    ...
    if (allActive) {
      if (!hasGroups) {
        if (canGroup) {
          options.push(React.createElement(StyledOption, {
            onClick: onGroup,
            key: "groupComponents"
  ...
  return React.createElement(StyledContainer$9, null, options);
};

var ContextMenu = function ContextMenu() {
  var _useProxy = useProxy(uiProxy),
  ...
  }, React.createElement(ComponentsMenu, {
    components: components
  })));
};
...
var Header = function Header() {
  var isEditMode = useIsEditMode();
  return React.createElement(StyledHeader$3, null, React.createElement(StyledHeaderSide, null, React.createElement("h3", null, "RGG")), React.createElement(StyledHeaderMiddle, null, React.createElement(StyledPlainButton, {
    shape: "thinner",
    onClick: function onClick() {
      setEditMode(!isEditMode);
    }
  }, isEditMode ? "Play" : "Edit")), React.createElement(StyledHeaderOptions$1, null, React.createElement(StyledPlainButton, {
    shape: "thinner",
    appearance: "faint",
    onClick: function onClick() {
  ...
  }, "Debug"), React.createElement(StyledPlainButton, {
    shape: "thinner",
    appearance: "faint"
  }, "Discard"), React.createElement(StyledPlainButton, {
    shape: "round",
    appearance: "faint",
    onClick: undoState
  }, React.createElement(FaUndo, {
    size: 9
  })), React.createElement(StyledPlainButton, {
    shape: "round",
    appearance: "faint",
...
var OverlayControls = function OverlayControls() {
  var transformMode = useTransformMode();
  return React.createElement(StyledBox$1, {
    css: {
      position: 'absolute',
      top: '$1',
      right: '$1',
  ...
  }, React.createElement(BiRotateLeft, {
    size: 16
  })), React.createElement(StyledBoxButton, {
...
var Editor = function Editor(_ref) {
  var children = _ref.children;
  useHotkeysListener();
  return React.createElement(React.Fragment, null, React.createElement(GoogleFontLoader, {
    fonts: [{
      font: 'Roboto',
      weights: [400, 500, 600, 700]
    }]
  }), React.createElement(GlobalHotkeysListener, null), React.createElement(StyledContainer$a, null, React.createElement(Header, null), React.createElement(StyledMain, null, React.createElement(StyledSidebar, null, React.createElement(ManagerSidebar, null), React.createElement(AddingComponentMenu, null)), React.createElement(StyledContent, null, children, React.createElement(OverlayControls, null)), React.createElement(StyledSidebar, {
    css: {
      width: '$sidebarPlus'
    }
  }, React.createElement(StateSidebar, null))), React.createElement(ContextMenu, null)));
};

var EditFloor = function EditFloor() {
  var isEditMode = useIsEditMode();
  return React.createElement(React.Fragment, null, React.createElement("gridHelper", {
    visible: isEditMode,
    position: [0, 0, -0.01],
...
var EditCamera = function EditCamera() {
  ...
  var selectedRef = useProxy(editorStateProxy).selectedRef;
  ...
  return React.createElement(React.Fragment, null, React.createElement(PerspectiveCamera, {
    ref: cameraRef
...
var AddingComponentPlane = function AddingComponentPlane() {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Plane, {
    args: [256, 256],
    ...
    ref: groupRef
  }, React.createElement(Sphere, null, React.createElement("meshBasicMaterial", {
    color: "green"
  }))));
};
...
var MultipleSelectedGroup = function MultipleSelectedGroup() {
  ...
  var dragMeshRef = useRef(new Object3D());
  var originRef = useRef(new Vector3());
  var positionDragRef = useCallback(function () {
  ...
  var startingPositionRef = useRef(new Vector3());
...
var EditTools = function EditTools() {
  ...
  return React.createElement(React.Fragment, null, React.createElement(EditFloor, null), React.createElement(EditCamera, null), React.createElement(MultipleSelectedGroup, null), addingComponent && React.createElement(AddingComponentPlane, null));
};

var EditCanvas = function EditCanvas(_ref) {
  var children = _ref.children;
  var isEditMode = useIsEditMode();
  return React.createElement(React.Fragment, null, children, isEditMode && React.createElement(EditTools, null), React.createElement(TemporaryComponents, null));
};
console.warn("TODO!!! - 'apply' function is stale, when updating component prop value");

export { EditCanvas, Editable, Editor, InteractiveMesh, predefinedPropKeys, registerAddable, useEditCanvasProps, useEditableProp, useEditableSharedProp, useIsEditMode };
//# sourceMappingURL=rgg-editor.esm.js.map
