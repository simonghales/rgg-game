...
var RAPIER = require('@dimforge/rapier3d-compat/rapier.js');

var createWorkerApp = function createWorkerApp(app) {
  reactNil.render(React.createElement(app, {
    worker: self
  }), null);
};
...
var generateUUID = three.MathUtils.generateUUID;
...
var SyncedComponentProp = function SyncedComponentProp(_ref) {
  ...
  var firstUpdateRef = React.useRef(true);
  React.useEffect(function () {
...
var SyncedComponent = function SyncedComponent(_ref2) {
  ...
  return React__default.createElement(React__default.Fragment, null, Object.entries(props).map(function (_ref3) {
    var key = _ref3[0],
        value = _ref3[1];
    return React__default.createElement(SyncedComponentProp, {
      key: key,
      id: id,
      propKey: key,
      value: value,
...
var useWorkerSendMessage = function useWorkerSendMessage() {
  return React.useContext(Context$2).sendMessage;
};
var useWorker = function useWorker() {
  return React.useContext(Context$2).worker;
};
...
var SyncComponents = function SyncComponents(_ref5) {
  ...
  var handleCustomMessage = React.useCallback(function (message) {
    var id = message.id,
        type = message.type,
        value = message.value,
  ...
  return React__default.createElement(React__default.Fragment, null, Object.entries(storedComponents).map(function (_ref6) {
    var key = _ref6[0],
        component = _ref6[1];
...
var FixedUpdateContext = /*#__PURE__*/React.createContext(null);
var useFixedUpdateContext = function useFixedUpdateContext() {
  return React.useContext(FixedUpdateContext);
};
var OnFixedUpdateProvider = function OnFixedUpdateProvider(_ref) {
  ...
  var onFixedUpdateSubscriptions = React.useRef({});
  ...
  return React__default.createElement(FixedUpdateContext.Provider, {
    value: {
...
var PhysicsConsumer = function PhysicsConsumer(_ref2) {
  ...
  var onFrameCallbacks = React.useRef({});
  var lerpMesh = React.useCallback(function (body, ref) {
    if (!ref.current) return;
    var object = ref.current;
    lerpBody(body, object, stepRate);
  }, []);
  var onUpdate = React.useCallback(function (updateTime, positions, angles, bodies) {
    if (bodies) {
  ...
  var syncMeshes = React.useCallback(function () {
  ...
  return React__default.createElement(WorkerMessaging, {
    worker: worker
  }, React__default.createElement(Context$1.Provider, {
    value: {
      syncBody: syncBody,
      syncMeshes: syncMeshes,
      sendMessage: sendMessage
    }
  }, React__default.createElement(PhysicsConsumerSyncMeshes, {
    useRAF: true
  }), children));
};

var Wrapper = function Wrapper(props) {
  return React__default.createElement(OnFixedUpdateProvider, null, React__default.createElement(PhysicsConsumer, Object.assign({}, props)));
};
...
var usePhysicsWorldStepHandler = function usePhysicsWorldStepHandler(onWorldStep, stepRate, paused) {
  ...
  var stepWorldRef = React.useRef(stepWorld);
  React.useEffect(function () {
...
var Physics = function Physics(_ref) {
  ...
  return React__default.createElement(OnFixedUpdateProvider, null, React__default.createElement(PhysicsProvider, {
...
var WorkerSubscription = function WorkerSubscription(_ref) {
  ...
  var updateWorker = React.useCallback(function (update) {
  ...
  var updateWorkerRef = React.useRef(updateWorker);
  React.useEffect(function () {
  ...
  var onUpdate = React.useCallback(function () {
    setUpdateCount(function (state) {
      return state + 1;
    });
  }, []);
  var onUpdateRef = React.useRef(onUpdate);
  React.useEffect(function () {
...
})(exports.FixtureShape || (exports.FixtureShape = {}));

var createFixtureShape = function createFixtureShape(shape, args) {
  switch (shape) {
    case exports.FixtureShape.Circle:
      return planckJs.Circle.apply(void 0, args);

    case exports.FixtureShape.Box:
      // @ts-ignore
      return planckJs.Box.apply(void 0, args);
  }
...
var usePhysicsBodies = function usePhysicsBodies(removeBody) {
  ...
  var hasPendingSyncedBodiesRef = React.useRef(0);
  var getPendingSyncedBodiesIteration = React.useCallback(function () {
    return hasPendingSyncedBodiesRef.current;
  }, []);
  var addSyncedBody = React.useCallback(function (uid, body) {
  ...
  var removeSyncedBody = React.useCallback(function (uid) {
    var index = syncedBodiesOrder.indexOf(uid);
    syncedBodiesOrder.splice(index, 1);
    delete syncedBodies[uid];
    hasPendingSyncedBodiesRef.current += 1;
  }, []);
  var addBody = React.useCallback(function (uid, body, synced) {
    if (synced === void 0) {
      synced = false;
    }
...
var usePhysicsUpdate = function usePhysicsUpdate() {
  ...
  var workerSubscriptionsRef = React.useRef({});
  var subscribeToPhysicsUpdates = React.useCallback(function (callback) {
...
var PlanckPhysicsHandler = function PlanckPhysicsHandler(_ref) {
  ...
  var removeBody = React.useCallback(function (body) {
  ...
  }, React__default.createElement(PlanckPhysicsWorkerMessagesHandler, {
    world: world,
    worker: worker
  }), React__default.createElement(Physics, {
    onWorldStep: onWorldStep,
    stepRate: stepRate
  }, children)));
};
...
var usePlanckPhysics = function usePlanckPhysics() {
  ...
  React.useEffect(function () {
    var planckWorld = new planckJs.World({
      allowSleep: false
    });
...
var PlanckApp = function PlanckApp(_ref) {
  ...
  return React__default.createElement(WorkerMessaging, {
    worker: worker
  }, React__default.createElement(PlanckPhysicsHandler, {
    world: world,
    worker: worker,
    stepRate: stepRate,
    maxNumberOfSyncedBodies: maxNumberOfSyncedBodies
...
var RAFSync = function RAFSync() {
  ...
  reactThreeFiber.useFrame(syncMeshes);
  return null;
};
...
var PhysicsConsumerSyncMeshes = function PhysicsConsumerSyncMeshes(_ref) {
  ...
  if (useRAF) return React__default.createElement(RAFSync, null);
  return React__default.createElement(IntervalSync, null);
};
...
var useBodyApi = function useBodyApi(id) {
  ...
  return React.useCallback(function (method, args) {
    sendMessage({
...
var createBody$1 = function createBody(world, bodyDef) {
  var body = new cannonEs.Body(bodyDef.body);
  bodyDef.shapes.forEach(function (_ref) {
    ...
    switch (type) {
      case 'Box':
        // @ts-ignore
        var box = new cannonEs.Box(_construct(cannonEs.Vec3, args.map(function (v) {
          return v / 2;
        })));
        body.addShape(box);
        break;
      ...
      case 'Sphere':
        // @ts-ignore
        var sphere = _construct(cannonEs.Sphere, args);
...
var quat = /*#__PURE__*/new three.Quaternion();
...
var CannonPhysicsHandler = function CannonPhysicsHandler(_ref) {
  ...
  }, React__default.createElement(CannonPhysicsWorkerMessagesHandler, {
    world: world,
    worker: worker
  }), React__default.createElement(Physics, {
    onWorldStep: onWorldStep,
...
var useCannonPhysics = function useCannonPhysics() {
  ...
  React.useEffect(function () {
    var cannonWorld = new cannonEs.World();
...
var CannonApp = function CannonApp(_ref) {
  ...
  return React__default.createElement(WorkerMessaging, {
    worker: worker
  }, React__default.createElement(CannonPhysicsHandler, {
    world: world,
    worker: worker,
    stepRate: stepRate,
    maxNumberOfSyncedBodies: maxNumberOfSyncedBodies
...
var PlanckPhysicsConsumer = function PlanckPhysicsConsumer(_ref) {
  ...
  return React__default.createElement(Wrapper, {
    ...
    worker: worker,
    stepRate: stepRate
  }, React__default.createElement(PhysicsConsumerHelpers, {
    prepareObject: prepareObject
  }, children));
};
...
var createColliderDesc = function createColliderDesc(colliderDef) {
  switch (colliderDef.type) {
    case "Ball":
      // @ts-ignore
      return RAPIER.ColliderDesc.ball.apply(RAPIER.ColliderDesc, colliderDef.args);

    case "Cubiod":
      // @ts-ignore
      return RAPIER.ColliderDesc.cuboid.apply(RAPIER.ColliderDesc, colliderDef.args);
  }
...
var createBody$2 = function createBody(world, bodyDef) {
  var rigidBodyDesc = new RAPIER.RigidBodyDesc(bodyDef.body.type);
...
var Rapier3DPhysicsHandler = function Rapier3DPhysicsHandler(_ref) {
  var children = _ref.children,
      ...
      worker = _ref.worker,
      maxNumberOfSyncedBodies = _ref.maxNumberOfSyncedBodies;
  var customRemoveBody = React.useCallback(function (body) {
  ...
  }, React__default.createElement(Rapier3DPhysicsWorkerMessagesHandler, {
    world: world,
    worker: worker
  }), React__default.createElement(Physics, {
    onWorldStep: onWorldStep,
...
var useRapier3dPhysics = function useRapier3dPhysics(stepRate) {
  ...
  var init = React.useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
...
var Rapier3DApp = function Rapier3DApp(_ref2) {
  ...
  return React__default.createElement(WorkerMessaging, {
    worker: worker
  }, React__default.createElement(Rapier3DPhysicsHandler, {
    world: world,
    worker: worker,
    stepRate: stepRate,
    maxNumberOfSyncedBodies: maxNumberOfSyncedBodies
...
var Rapier3DPhysicsConsumer = function Rapier3DPhysicsConsumer(_ref) {
  ...
  return React__default.createElement(Wrapper, Object.assign({
    updateBodyData: updateBodyData$1,
    lerpBody: lerpBody$1
  }, props), React__default.createElement(PhysicsConsumerHelpers, {
...
exports.CannonApp = CannonApp;
exports.CannonPhysicsConsumer = CannonPhysicsConsumer;
exports.Physics = Physics;
exports.PhysicsConsumer = Wrapper;
exports.PhysicsConsumerSyncMeshes = PhysicsConsumerSyncMeshes;
exports.PlanckApp = PlanckApp;
exports.PlanckPhysicsConsumer = PlanckPhysicsConsumer;
exports.Rapier3DApp = Rapier3DApp;
exports.Rapier3DPhysicsConsumer = Rapier3DPhysicsConsumer;
exports.SyncComponents = SyncComponents;
exports.SyncedComponent = SyncedComponent;
exports.createBody = createBody$2;
exports.createWorkerApp = createWorkerApp;
exports.rawActiveKeys = rawActiveKeys;
exports.useActiveKeys = useActiveKeys;
exports.useBodyApi = useBodyApi;
exports.useCannonBody = useCannonBody;
exports.useOnFixedUpdate = useOnFixedUpdate;
exports.usePhysicsConsumerContext = usePhysicsConsumerContext;
exports.usePlanckAppContext = usePlanckAppContext;
exports.usePlanckBody = usePlanckBody;
exports.useRapier3DBody = useRapier3DBody;
exports.useSyncBody = useSyncBody;
//# sourceMappingURL=rgg-engine.cjs.development.js.map
